...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "2.6.x"
  WORKING_DIRECTORY "/Users/sayyed/Documents/Personal/Array-Jumper/Array-Jumper/build/_deps/sfml-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/sayyed/Documents/Personal/Array-Jumper/Array-Jumper/build/_deps/sfml-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/sayyed/Documents/Personal/Array-Jumper/Array-Jumper/build/_deps/sfml-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
